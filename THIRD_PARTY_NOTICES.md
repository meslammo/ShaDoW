...
- Shared wake assets fetched during CI:
  - melspectrogram.onnx
...
- Project license: MIT
- Note: this is the sole SHADOW wake classifier used by the current build. Physical microphone validation is a later device test, not a build prerequisite.
