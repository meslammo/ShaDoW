"""MOD-37.8: unified production runtime facade."""
...
class RuntimeCapabilities:
    ...
    self_test:bool; device_capability_model:bool
...
class ProductionRuntime:
    ...
    def capabilities(self)->RuntimeCapabilities:
        return RuntimeCapabilities(True,True,True,True,True,True,True,True,self.github.authorized,True,True,True,True,True)
    ...
    def status(self)->dict[str,Any]:
        return {"workspace":str(self.workspace),"capabilities":self.capabilities().to_dict(),"voice":self.voice.status(),"github":self.github.summary(),"memory":self.memory.status(),"skills":[asdict(s) for s in self.skills.list()]}
