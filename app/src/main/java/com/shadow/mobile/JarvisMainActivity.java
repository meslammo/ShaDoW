...
public class JarvisMainActivity extends Activity implements TextToSpeech.OnInitListener {
    ...
    @Override protected void onDestroy(){handsFreeVoice=false;voiceHandler.removeCallbacksAndMessages(null);if(voiceState!=null)voiceState.setHandsFree(false);stopBargeInMonitor();if(bargeInMonitor!=null)bargeInMonitor.destroy();if(voice!=null)voice.destroy();stopCurrentTts();if(tts!=null)tts.shutdown();super.onDestroy();}
}
